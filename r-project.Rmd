...
total_data %>% 
  ...
  labs(title="Histogram of Rider Time Affected by Rain", x="Trip Duration", y="Density")
```
...
total_data %>% 
  ...
  geom_density(alpha=.2, fill="#FF6666") + 
  geom_vline(aes(xintercept=mean(tripduration)), color="blue", linetype="dashed", size=1) +
  labs(title="Histogram of Rider Time Affected by Snow", x="Trip Duration", y="Density")
```
...
total_data %>% 
  ...
  geom_density(alpha=.2, fill="#FF6666") + 
  geom_vline(aes(xintercept=mean(tripduration)), color="blue", linetype="dashed", size=1) +
  labs(title="Histogram of Rider Time Affected by Wind", x="Trip Duration", y="Density")
```
